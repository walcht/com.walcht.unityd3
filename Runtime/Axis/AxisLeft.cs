...
namespace UnityD3
{
    public class AxisLeft<InputType> : Axis<InputType> where InputType : unmanaged, IFormattable
    {

        /// <summary>
        ///     Constructs a new left-oriented axis generator for the given scale. In this orientation, ticks are drawn
        ...
        public AxisLeft(IScaleContinuous<InputType, float> scale, int tick_count = 6) : base()
        {
            m_scale = scale;
        ...
        public override Axis<InputType> Update()
        {
            ...
            ConstructMainLine(new(0.0f, 1.0f, 0.0f));
            ConstructTickContainers(new(0.0f, 1.0f, 0.0f));
            ConstructTickLines(new(1.0f, 0.0f, 0.0f));
            ConstructTickTexts(new(1.0f, 0.0f, 0.0f));
